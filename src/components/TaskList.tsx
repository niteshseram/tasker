...
export default function TaskList() {
  return (
    <div className="overflow-x-auto sm:rounded-lg border-gray-200 border">
      <table className="w-full text-sm text-left rtl:text-right text-gray-400">
        <thead className="text-gray-700 bg-gray-200 sticky top-0 z-1">
          <tr>
        ...
        <tbody>
          {tasks.map(task => (
            <tr className="border-b border-gray-200 text-black" key={task.id}>
              <th
                scope="row"
